...
public class ComprobanteService {
    ...
    @Transactional //asegura que las operaciones se realicen en una única transacción y se confirmen o reviertan en caso de error.
